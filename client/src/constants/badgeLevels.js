...
//                 the badge image. Levels 3 + 4 reuse `color`; levels 1, 2,
//                 and Preschool get one-step-lighter Tailwind shades; Level
//                 5 needs a much lighter track because its `color` is
//                 already a dark grey.
export const BADGE_LEVELS = {
  preschool: { label: 'Preschool · Penguin',   ageRange: 'Ages 3-5',    color: '#FCA5A5', textColor: '#7F1D1D', borderColor: '#EF4444', trackColor: '#FECACA' /* red-200    */ },
  level1:    { label: 'Level 1 · Otter',       ageRange: 'Ages 5-8',    color: '#FDE047', textColor: '#713F12', borderColor: '#FBBF24', trackColor: '#FEF08A' /* yellow-200 */ },
