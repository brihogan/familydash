  ...
  return (
    <>
      {variant === 'button' ? (
        ...
        >
          <FontAwesomeIcon icon={faPlusMinus} className={large ? 'text-base' : 'text-xs'} />
        </button>
      )}
      ...
      <Modal open={open} onClose={handleClose} title="Adjust Tickets">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Add / Remove toggle */}
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-wider">New Adjustment</p>
