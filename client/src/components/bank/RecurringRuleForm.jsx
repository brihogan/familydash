    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div>
          ...
          <input type="number" step="0.01" min="0.01" value={dollars}
            ...
            className="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-sm" placeholder="0.00" />
        </div>
        <div>
      ...
      <div>
        ...
        <input type="text" value={description} onChange={(e) => setDescription(e.target.value)}
          className="w-full border border-gray-300 rounded-lg px-2 py-1.5 text-sm" placeholder="Weekly allowance" maxLength={200} />
      </div>
