  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand-50 to-purple-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-8">
        <h1 className="text-2xl font-bold text-center text-gray-800 mb-2">Create Your Family</h1>
        <p className="text-sm text-center text-gray-500 mb-6">Set up your family dashboard</p>
